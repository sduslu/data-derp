module "glue-job" {
  ...
  additional-params = {
//    "--additional-python-modules": "s3://${var.project-name}-${var.module-name}/data-transformation/data_transformation-0.1-py3.egg", # https://docs.aws.amazon.com/glue/latest/dg/reduced-start-times-spark-etl-jobs.html
