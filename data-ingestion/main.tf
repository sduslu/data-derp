module "glue-job" {
  ...
  additional-params = {
    ...
    "--temperatures_country_input_path":  "s3://twdu-europe-data-source/TemperaturesByCountry.csv",
    "--temperatures_country_output_path": "s3://${var.project-name}-${var.module-name}/data-ingestion/TemperaturesByCountry.parquet",
    "--temperatures_global_input_path":   "s3://twdu-europe-data-source/GlobalTemperatures.csv",
    "--temperatures_global_output_path":  "s3://${var.project-name}-${var.module-name}/data-ingestion/GlobalTemperatures.parquet",
    "--co2_input_path":                   "s3://twdu-europe-data-source/EmissionsByCountry.csv",
